---
title: Dan Moore and Boulder Ruby
voice: Dan Moore
host: Hans Schnedlitz
date: 2026-07-24
teaser: >-
  Dan talks about wrangling speakers for Boulder Ruby, helping new speakers get started, planning without booking too far ahead, varying meetup formats, and knowing when it is time to step away.
links:
  - label: "Boulder Ruby"
    url: https://boulder-ruby.org/
    icon: conference
  - label: "@mooreds.com"
    url: https://bsky.app/profile/mooreds.com
    icon: bluesky
  - label: "mooreds.com"
...
highlights:
  ...
  - title: "Helping new speakers get started"
    anchor: helping-new-speakers-get-started
  - title: "Booking two to three months ahead"
    anchor: booking-two-to-three-months-ahead
  - title: "Staying flexible with meetup formats"
    anchor: staying-flexible-with-meetup-formats
  - title: "When a speaker cancels"
    anchor: when-a-speaker-cancels
  - title: "Promoting the meetup"
    anchor: promoting-the-meetup
  - title: "Knowing when to step away"
    anchor: knowing-when-to-step-away
---

**Hans:** It's great that you're taking the time. You're the first non-European I have the pleasure of talking to. Awesome that you shared the Guides on Hacker News. Huge thanks for that. That's great. And also thanks for the input. Some great stuff in there. I think with the guides, it's always nice to get actual conversations, right? Get the actual experiences, because your list, for example, is great, but I'm super interested in the experiences and where they're coming from.

**Dan:** Yeah.

**Hans:** But we're gonna get into that stuff. So yeah, once again, thanks so much for taking the time. We're just gonna do it loosey-goosey, right? But let's start with the easy part first, like, who are you and what's your meetup?

**Dan:** So I have been a developer for a long time. I currently don't do development. I'm more of a product person. But I was introduced to Ruby. I did a little bit of work in the mid-2010s, but in 2016, I co-founded a startup and we used Rails and a layer on top of Rails to build it out. And then I got introduced to Boulder Ruby Group. And after a couple years, that's where I started volunteering. I'd say pre-COVID, maybe 30-ish people would attend. And then afterwards, definitely kind of decayed. We lasted through COVID, but I'd say probably 10-ish people a month now attend, maybe 15, or if we have a big name, maybe a little more. But yeah, so I just fell in love with the community. I like the language a lot. I've been a developer long enough that I care less about languages than I used to. But I still, I mean, for a web app, like, I'm like, why are you thinking about anything else other than Ruby? Certainly for the first couple of years of any company or organization. Unless there's always a skill set issue, but like, that's my default. So yeah.
...
**Dan:** I don't know if there's any more for that group. I know some meetups do conferences or, you know, for a while pre-COVID we were doing hackfests, like where people come and work on stuff. But, you know, that's a natural extension. But yeah, so a team and if you want to, I can definitely reach out. There's two folks who are still kind of doing it after I left and maybe they've added somebody, I don't know. But they're like actively in it.

**Hans:** I think that's fine. I'm already talking to people who are still in it. So we can talk about the guides. I think you read some of it. I just want to have a wide breadth of experience, because every meetup and every event, like a conference, is so different. And it's a matter of personal taste, right? It's your space. It's your community if you're organizing a meetup, in a way. And every city is different. The people in the city are different, right? So I want to give these checklists, these “hey, this is what you could do” ideas, some depth and a lot of context. So I'm looking for everything. I want to talk to people in Asia. I have no idea what conferences look like in Southeast Asia, right?

**Dan:** Sure.

**Hans:** And that's completely fine. It's also, I think, a valid experience. Like, you used to organize meetup, now you don't anymore. So maybe we can dig into that a bit later.

**Dan:** Totally.

**Hans:** But let's—so, and I'm not that structured yet. Let's talk about what you did at the meetup specifically, because I think you have a lot of great tips for, like, as you described, the speaker wrangling. Maybe you can get into that, like, what was your job in the space of the meetup?
...
**Dan:** And meetups give you this opportunity to take that step. And I definitely had some people who went into like sales engineering roles, or I'm trying to think of anybody who went into DevRel. Some people just did one talk and then like went back to being a dev. Right, which is totally cool too.

**Hans:** So yeah, you try it and then you're like, maybe it's not for me. But I also see that sometimes people are like, how do you say that in English? Tasting blood. Is that right? It's a bit violent, but you know what I'm saying? Like, they get into it, right?

**Dan:** Sure.

**Hans:** They have their first experience. They're like, I'm not really sure if I'm on stage. And then they do it and they're like, that's great. And they go on to do more talks. and more and more things. And that's always nice to see when they get their start in like a small local community, right?

**Dan:** Definitely.

**Hans:** Yeah. So it sounds like you approached this whole organizing speakers pretty professionally. I think you also mentioned in the blog post, like you had a spreadsheet and months in advance. I'd love to go in depth there because you have a lot of experience. That's amazing. How can I imagine that? Like, how many months in advance are you talking? Like, how would you approach that? Right?

**Dan:** Yeah.

**Hans:** Yeah. So you're like, we need a speaker for, or maybe we can talk about that. How often do you do Boulder Ruby?

**Dan:** It was once a month.

**Hans:** Once a month. Right. So, okay, we got the next four months booked out. We got a speaker and backups potentially. So you're like, I need somebody for July.
...
**Dan:** So we're gonna just kind of get together and hang out in the park or meet someplace for a holiday thing. So that takes some pressure off. We actually did, during the time I was there, find kind of an anchor speaker who was a local GitHub employee who did a bunch of, like, every year he would do a presentation at RailsConf until he had some family stuff interfere with last year. So he'd always kick the year off in January with that. And it was like practice for him for his RailsConf talk.
...
**Dan:** And you just say, oh, I'm gonna write your name in. And about six weeks before, I will reach out to you and we'll nail down the presentation topic, blah, blah, blah. At one point, I think I was booking six or so months out.

**Hans:** Wow.

<span id="booking-two-to-three-months-ahead" class="interview-anchor"></span>

**Dan:** And that actually backfired because people would change jobs, or people would be really enthusiastic about it, but then—especially a newer developer—they might explore something else. And like, some people moved out of the Ruby community entirely in that period of time. And then they're like, I'm sorry, I can't do this. And I understand, like, you're doing it for free. It's your time. So I kind of learned to keep a buffer of like two to three months, and that's really about as far out as I think you want to book. Unless of course it's like, again, an Aaron Patterson or somebody like that who, you know, we could book them out a year and you know that they're gonna show up and be a good speaker.

**Hans:** So yeah, right. Yeah, super. So you had a spreadsheet to like keep track in like 6 months in advance and how often would you follow up with them like a month ahead of time then?

**Dan:** Yeah, usually. Sometimes you saw them around, but sometimes you didn't. So usually about, I wanna say six weeks, four weeks before the talk, I would be like, okay, now I need your bio, now I need all this stuff. And that was, you know, by doing it that far ahead of time, if they had shifted positions or had life things where they're like, I just can't do a talk now, I would be able to say, oh, you know, you can't do it in July, you know, would August or September work better? Yeah. And sometimes they'd say yes, and sometimes they'd say no, I just, I really can't. And either way, you have some buffer to try to find somebody else. There was and is a local Slack channel we have that's a Boulder Slack channel.

**Hans:** And is it just for Ruby or like—

**Dan:** So it's kind of, it's got a couple thousand members. It's been around for 15 years, but the most active channels are Ruby, really. Like, there's an AI channel which is pretty busy, but like—
...
**Hans:** I think that's like keeping meetups fresh and fun and keeping the community fun. I think that's a core challenge and it's just a lot harder if you do it once a month because you gotta keep delivering essentially once a month and that can get stressful. So I couldn't imagine doing that by myself. Like, there's just me and one co-organizer that does some stuff, but it's mostly me and just doing all that once a month.

**Dan:** Yeah.

**Hans:** Yeah, I'd need a speaker wrangler for sure. But there's some interesting stuff in there. Like you said, you tried different formats. Maybe we can go into that. Panels. Do you do lightning talks as well?

**Dan:** Yeah, before COVID we actually—
...
**Hans:** Awesome. But after like just around COVID, a bit before it like went into slump, like where like it was the same seven people showing up. And so in 2024. I took over as an organizer from Carmen. And I think that was the second meetup that I organized, like, after the revival. We just had lightning talks, and you could see, like, people from other countries also being interested. From a perspective of a speaker, I think lightning talks are always nice, right? Because the barrier is so much lower. Like, if you're like, hey, you want to talk forty minutes about something, people are like, totally, you know, especially if they're like, what first-time speakers, which were like, hey, ten-minute talk, you know, somebody might be, oh, I guess this topic, it's a lot, but I can do a talk. That's also nice. But yeah, I'm so curious about different formats, like talking to other people. You notice your own blind spots. You're like, oh shit, I never thought of that.

**Dan:** Sure.

**Hans:** Like you mentioned, you were doing panels. I did a panel at a conference, but I would have never thought about doing a panel at the meetup. So yeah, awesome.

**Dan:** And I never thought about doing an entire meetup of lightning talks. I think that'd be super fun to do.

**Hans:** So yeah, man, there's so much stuff to talk about, right? Let me just say speakers, right? Yeah. What's your backup? Like, have you had situations where like you had two talks lined up and both of them canceled? Like, what did you do, just have a backup lined up, or did you ever have to do a talk? Was that a topic, like one of the organizers just does a talk?
...
**Hans:** Yeah, for sure. So far we've been lucky in that regard. So it's, yeah, nice. Maybe we can get into some adjacent topics because you mentioned also that you announce speakers, right? Maybe a month in advance or maybe even several months in advance. Maybe it's a big speaker. And let me know if this is like out of your wheelhouse, right? If somebody else was doing more of that. But like, maybe we can get a bit into promotion because I think it's adjacent, right? What do you do generally, or what did you generally do to promote your meetup or promote speakers?

<span id="promoting-the-meetup" class="interview-anchor"></span>

**Dan:** Yeah, yes, actually I wrote up a doc around that. I don't know where it is, probably on Google Drive someplace, because I was trying to outsource that to another volunteer. So in my mind, you need to announce it multiple times. The first step is obviously making sure the meetup page is accurate and the speakers reviewed it. Especially people love to have their bio correct, which I totally get, but also the talk topic and stuff like that so that possible attendees can plan. Then, you know, the main— there are, I guess, three main venues. The first is the actual meetup itself. So telling people what's happening next month, if you can, with certainty.
...
**Dan:** Yeah, I think that's a great example. Yeah, you might do something like that for sure. I mean, it's more likely that like you would go to the places where Ruby devs were already hanging out. But certainly if you had a cross-platform thing, right, like that career panel might be, you know, again, you as a marketer, you're always walking this line between being spammy and letting people know something that's interesting, right, that you think is interesting. And you get a little more of a pass, a little more grace from if you're like a nonprofit or you're like just doing this as a volunteer as opposed to like being a paid, you know, DevRel or some other way. But yeah, so there's definitely— I'm probably a member of like 12 different Slacks, and some of them are worldwide, some of them are super local, some of them have—
...
**Dan:** So like, the number of times that people said, I'm doing this on my own time. I wish I could program Ruby at my job is non-zero. Like, there were definitely a number of times where people said that, which I don't think you're hearing about that about other languages as much.

**Hans:** Yeah, for sure. I mean, apart from the technical merit, it's just, it's just the nicest community. I'm also like continuously baffled by like, oh, people are just generally lovely. So definitely mirrors your experience. Maybe in that vein, is there any particular moment that you're like very proud of in hindsight where like, oh, that was just lovely?

**Dan:** I mean, honestly, I mean, two jump to mind and there's kind of a theme there, but I got the founder of Sidekiq, just interacted with him on Twitter a couple of times and just asked him to like do an AMA and he did that. And that was our first kind of—when I was running speakers, that was the first person that was like a recognizable person that we had talk. And then we actually planned to— we had a bunch of sponsorship money and we actually planned for Aaron Patterson, who lives in, I think, Seattle, to fly out and actually do an in-person talk during Startup Week at Boulder.

**Hans:** Mm-hmm.

**Dan:** And during Boulder Ruby, and it ended up not happening because I want to say COVID was the reason it didn't happen, but he still came on and gave just an amazing talk. And, you know, I should probably think about a moment that's like not like a big name moment, but like both those are things where I put a lot of work into and it was cool to see that happen.

**Hans:** Yeah.

**Dan:** And that's kind of the thing you can make happen for sure. And if you do this volunteering, it's not beyond the realm. I'm no special person and we didn't have a ton of money. Like, we didn't end up even paying Aaron. We were just gonna pay for his flight and hotel. Like, yeah, but you can do that because the community.

**Hans:** Yeah. So two more things. First is also an interesting topic, like why do people stop doing the meetup? And in your case particularly, is that you're not part of the organizing team anymore. Maybe you can go in real quick into why that is the case. 

<span id="knowing-when-to-step-away" class="interview-anchor"></span>

**Dan:** Yeah, first of all, I stopped doing software development as much, like I mentioned. And then second, I wasn't doing much Ruby. And I guess third, I wanted more space in my life. And, you know, I feel like you should never start something that you don't have interest in doing for a couple of years at least. It doesn't mean you have to do it, but I don't think you should start it. And I had done it for 4 or 5 years and I was just like, you know, I've done my time. I helped out the community and I wasn't active in it anymore. And that's a side benefit of being a wrangler is like, or being an organizer is like, you're attuned to community. So you're attuned to trends in the community and like what people are talking about and things like that.

**Hans:** Right.

**Dan:** And if you're thinking about being an organizer, that's definitely a benefit. But if you're now removed from that community, you're not doing stuff in that community anymore, it's less of a benefit.

**Hans:** Yeah, true. Awesome. Yeah, that— I think that's mostly it. I think before we wrap up, like I said, I want to do way more of these. I love them. I love these interviews. So again, it's just great to connect to people. Literally what you just said. Like, A, yeah, organizing the meetup, organizing RubyConf Austria, that was all great and fun. But also just this project, talking to people and getting the input.
...
**Hans:** No, just the transcripts. I was thinking about the audio and stuff. It's a bit finicky. Maybe at some point, but for now, transcript. Great. Awesome.

**Dan:** I look forward to that. Let me know, and I'll put it on Hacker News too. So awesome.

**Hans:** Cool. Thanks so much. All right, have a great day. Bye-bye.
