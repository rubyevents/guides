...
If I were to have it in Michigan, like driving distance from my house, that would be a lot different and a lot better in a lot of ways, because, for example, I could just go drive over and scope out the venue without having to pay to go to Las Vegas, fly there, and do this whole thing just to check out the venue. We never did that, because that wasn't realistic. That would just eat away at the expenses so much.
...
And then once I got into the process, okay, so usually you fill out a form. They ask you how many people you're expecting, what dates you're thinking, and all that kind of stuff. They'll contact you and give you an email that's worded in such a way that it doesn't make any sense. You have to respond and ask, what do you mean, and stuff like that. But anyway, a conversation starts, and they're going to want some kind of deposit or something like that. So you do that, get the scheduling taken care of. Maybe there's a little bit of negotiation around budget and stuff like that.

Quite often, in fact, I found this universally to be the case in Las Vegas, they require you to have a room block in connection with your event, because they want that guaranteed revenue from you. In order to do this one, we had to have, we were expecting, like we told them, a hundred people. But we don't know, we just have to guess. We said a hundred people. So they made us do a room block for a hundred people, and we had to fill that to at least 80%. If we didn't fill it to 80%, then we would be responsible for any rooms that we didn't fill.

So that's a big part of where the risk comes from. And this hotel, I don't remember how much a night, but multiply a couple hundred bucks a night times two nights times 80 rooms. That's a pretty big number, and that's the number that we were on the hook for. And then on top of that, in this case, the $26,000 food and beverage minimum, or whatever it was, because again they want that guaranteed revenue.
